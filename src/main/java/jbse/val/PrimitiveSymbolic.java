...
public final class PrimitiveSymbolic extends Primitive implements Symbolic, Serializable {
	 ...
	 * 
	 * @param id
	 *            an {@link int}, the identifier of the symbol. Different object
	 *            with same identifier will be treated as equal.
	 * @param type
	 *            the type of the represented value.
	 * @param origin
	 *            a {@link MemoryPath}, the origin of the symbol.
	 * @param calc
	 *            a {@link Calculator}.
	 * @throws InvalidTypeException
	 *             if {@code type} is not primitive.
	 */
	PrimitiveSymbolic(int id, char type, MemoryPath origin, Calculator calc) throws InvalidTypeException {
		...
		//added origin's hashCode to identify identical hashCodes
	...
	/**
	 * {@inheritDoc} For {@link PrimitiveSymbolic} values it will always return
	 * {@code true}.
	 */
	@Override
	...
	/**
	 * {@inheritDoc} For {@link PrimitiveSymbolic} values it will always throw
	 * {@link ValueDoesNotSupportNativeException}.
	 */
	@Override
	...
	/**
	 * {@inheritDoc} For {@link PrimitiveSymbolic} values it will return
	 * {@code false}.
	 */
	@Override
	...
	/**
	 * {@inheritDoc} Two {@link PrimitiveSymbolic} values are equal iff they have
	 * same identifier.
	 */
	@Override
	public boolean equals(Object obj) {
		...
		// added comparison with origin accesess
		if (id != other.id && !origin.equals(other.origin)) {
			return false;
		}
		return true;
	}
	...
	public String originFragmented() {
		return this.origin.originFragmented();
	}
}